                ...
                Align(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                              padding: getPadding(left: 18, top: 96),
                              child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Padding(
                          ...
                          CustomElevatedButton(
                              ...
                              margin: getMargin(left: 15, top: 27, right: 21),
                              leftIcon: Container(
                          ...
                          CustomOutlinedButton(
                              text: "View More ",
                              margin: getMargin(left: 19, top: 25, right: 18),
                              buttonStyle: CustomButtonStyles.outlineBlueA700
                                  .copyWith(
                                      fixedSize:
                                          MaterialStateProperty.all<Size>(Size(
                          ...
                          Container(
                              margin: getMargin(left: 19, top: 16, right: 18),
                              padding: getPadding(
                              ...
                              child: Stack(
                                  ...
                                  children: [
                                    ...
                                    CustomImageView(
                                        ...
                                        width: getSize(49),
                                        alignment: Alignment.topRight,
                                        margin: getMargin(top: 21, right: 41))
                                  ]))
                        ])),
                Align(
                    alignment: Alignment.topCenter,
                    child: Container(
                        width: double.maxFinite,
                        margin: getMargin(top: 176, bottom: 487),
                        padding:
                            getPadding(left: 18, top: 5, right: 18, bottom: 5),
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              CustomImageView(
                                  ...
                                  width: getSize(2),
                                  margin:
                                      getMargin(left: 28, top: 21, bottom: 20)),
                              Padding(
                              ...
                              Padding(
                                  padding:
                                      getPadding(left: 11, top: 1, bottom: 2),
                                  child: Column(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      mainAxisAlignment:
                ...
                Align(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                            padding: getPadding(left: 17, top: 19, right: 23),
                            child: Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                        ...
                        Padding(
                            padding: getPadding(left: 17, top: 14, right: 23),
                            child: Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
